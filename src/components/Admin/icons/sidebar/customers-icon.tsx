...
export const OdersIcon = (isActive:any) => {
  return (
<svg width="24px"  height="24px"  viewBox="0 0 24 24"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
    <g id="Iconly/Light/Discount" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" strokeLinecap="round" strokeLinejoin="round">
        <g id="Discount" transform="translate(2.000000, 2.000000)"  className={`${isActive.isActive ? "stroke-white" : "stroke-default-900"}`}>
            ...
            <line x1="12.4955" y1="12.5" x2="12.5045" y2="12.5" id="Stroke-11" strokeWidth="2"></line>
            <line x1="7.4955" y1="7.5" x2="7.5045" y2="7.5" id="Stroke-11" strokeWidth="2"></line>
        </g>
    </g>
</svg>
  );
