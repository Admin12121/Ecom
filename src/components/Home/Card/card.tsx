...
export const  CardBox = ({ product, clasName }: CardBoxProps) => {
  ...
  return (
        <div
          ...
          className={`clone_element relative flex w-80 flex-col rounded-xl ${clasName ? clasName : "" } text-white shadow-md `}>
          <span className="pointer-events-none absolute rounded-xl -inset-px opacity-0 transition duration-500" style={{
            ...
            <Link
                ...
                className="relative mx-4 -mt-6 h-56 top-[-100px] rounded-xl bg-blue-gray-500 bg-clip-border ">
                <Image
                    isBlurred
                    as={NextImage}
                    width={400}
            ...
            <span className="maintext-content">
              <div className="p-6 hidden-element">
              ...
              <div className="p-6 pt-0 flex justify-between items-center">
                  <span className="cursor-pointer text-gray-300 hidden-element">
                    {symbol} {convertedPrice}
                  </span>
                  <Button color="secondary" className="cursor-pointer hidden-element"    onClick={(event) => addToCart(product!.id, event, variantId)}>
                    Add to Cart
