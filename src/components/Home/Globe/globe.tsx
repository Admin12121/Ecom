...
export function GlobeDemo() {
  ...
  const sampleArcs = [
    {
      order: 1,
      startLat: kathmanduLat,
      startLng: kathmanduLng,
      endLat: -22.9068,
      endLng: -43.1729,
      arcAlt: 0.1,
  ...
  return (
    <div className="flex flex-row items-center justify-center py-20 h-screen md:h-auto relative w-full max-lg:h-[90vh]">
      <div className="max-w-7xl mx-auto w-full max-lg:flex items-center relative flex flex-col overflow-hidden h-full md:h-[35rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
          ...
          className="div absolute top-[50%] left-0 max-lg:relative max-lg:top-0"
        >
