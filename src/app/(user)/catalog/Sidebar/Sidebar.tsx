...
const Sidebar = () => {
  ...
  return (
    <div className="min-w-[350px] w-[20%] py-4  pl-5 flex min-h-[100vh] h-full flex-col gap-5 max-llg:hidden">
      <Accordion
        variant="splitted"
