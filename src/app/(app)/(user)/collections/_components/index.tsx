...
import { useProductsViewQuery, useTrendingProductsViewQuery } from "@/lib/store/Service/User_Auth_Api";
...
const CollectionPage = () => {
  ...
  return (
    ...
    <section className="flex flex-col gap-5 pt-5">
      {search && (
        <span className="">
          <p className="text-neutral-600 dark:text-themeTextGray ">Search results for</p>
          <h1 className="text-3xl font-bold text-neutral-700 dark:text-themeTextWhite">{search}</h1>
        </span>
      )}
